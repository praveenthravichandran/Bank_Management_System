...
<body>
    <form class="add_customer_form" action="./edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="tamilnadu" <?php if ($branch == 'Chennai') {?> selected="selected" <?php }?>>Chennai</option>
                    <option value="tamilnadu" <?php if ($branch == 'Coimbatore') {?> selected="selected" <?php }?>>Coimbatore</option>
                    <option value="tamilnadu" <?php if ($branch == 'Salem') {?> selected="selected" <?php }?>>Salem</option>
                    <option value="tamilnadu" <?php if ($branch == 'Namakkal') {?> selected="selected" <?php }?>>Namakkal</option>
                    <option value="tamilnadu" <?php if ($branch == 'Trichy') {?> selected="selected" <?php }?>>Trichy</option>
                    <option value="tamilnadu" <?php if ($branch == 'KanyaKumari') {?> selected="selected" <?php }?>>KanyaKumari</option>
                </select>
            </div>
        </div>
